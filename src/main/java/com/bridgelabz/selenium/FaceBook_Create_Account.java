...
/*Create Facebook account using different browsers*/
...
public class FaceBook_Create_Account {
    ...
    void typeOfBrowser() throws InterruptedException {
    ...
    void createAccount_Chrome() throws InterruptedException {
    ...
    void createAccount_Edge() throws InterruptedException {
